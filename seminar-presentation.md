...
<!--
1. In VSCode, you uncomment the below definition.
2. Select just the code.
3. Ctrl + Shift + P, "copy with syntax highlighting"
4. In terminal: `xclip -selection clipboard -o -t text/html`
5. copy output!
6. ehhh, doesnt' work that well...
-->
